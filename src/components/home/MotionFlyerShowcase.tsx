...
const MOTION_DISHES: DishFlyer[] = [
  ...
  },
  {
    ...
    subtitle: "Golden Crepe Stuffed with Spiced Aloo Mash",
    tagline: "RICH BUTTER • SAVORY • FLAVORFUL",
    ...
    category: "Tiffins",
    spicyLevel: 2,
    ingredients: ["Yellow Butter Dollop", "Tempered Potato Mash", "Mustard & Green Chilies", "Coconut Chutney"],
    accentColor: "#EAB308",
    bgWord: "BUTTER MASALA",
    highlights: "Wafer-thin golden roast topped with melting butter and fragrant spiced potatoes.",
  },
  {
